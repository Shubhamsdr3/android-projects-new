...
public class VideoPlayerRecyclerView extends RecyclerView {
        ...
        addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    Timber.d("onScrollStateChanged: called.");
                    if(thumbnail != null) {
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        Timber.d("playVideo: target position: %s", targetPosition);
        ...
        thumbnail = holder.itemView.findViewById(R.id.thumbnail);
        progressBar = holder.itemView.findViewById(R.id.progressBar);
        volumeControl = holder.itemView.findViewById(R.id.volume_control);
    ...
    private int getVisibleVideoSurfaceHeight(int playPosition) {
        ...
        Timber.d("getVisibleVideoSurfaceHeight: at: %s", at);
    ...
    private void toggleVolume() {
        if (videoPlayer != null) {
            if (volumeState == VolumeState.OFF) {
                Timber.d("togglePlaybackState: enabling volume.");
                setVolumeControl(VolumeState.ON);

            } else if(volumeState == VolumeState.ON) {
                Timber.d( "togglePlaybackState: disabling volume.");
    ...
    private void animateVolumeControl(){
        if(volumeControl != null){
            ...
            if(volumeState == VolumeState.OFF){
                requestManager.load(R.drawable.ic_valume_off_grey)
                        .into(volumeControl);
            }
            else if(volumeState == VolumeState.ON){
                requestManager.load(R.drawable.ic_valume_up_grey)
                        .into(volumeControl);
            }
